...
export default function Payment({ params }: any) {
    ...
    window.IMP.request_pay(
      {
        ...
        customer_uid: "gildong_0001_1234", // 회원 번호
  ...
  const subscribeItemClickHandler = (e: any) => {
    var IMP = window.IMP;
    IMP.init(process.env.NEXT_PUBLIC_IAMPORT_API_KEY); // iamport 가맹점 식별코드
    IMP.request_pay({
        pg: 'html5_inicis',
        ...
        customer_uid: 'ismp_uid', // 필수 입력.
        buyer_email: 'iamport@siot.do',
        buyer_name: '아임포트',
        buyer_tel: '02-1234-1234',
        m_redirect_url: 'https://www.my-service.com/payments/complete/mobile' // 예: https://www.my-service.com/payments/complete/mobile
    }, function (rsp: any) {
        if (rsp.success) {
            alert('빌링키 발급 성공');
        } else {
